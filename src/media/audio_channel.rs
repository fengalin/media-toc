...
impl AudioChannel {
    pub fn new(position: &gst_audio::AudioChannelPosition) -> Self {
        let (side, factor) = match *position {
            ...
            Position::FrontLeftOfCenter => (AudioChannelSide::Left, 0.75f64),
            Position::FrontRightOfCenter => (AudioChannelSide::Right, 0.75f64),
            Position::RearCenter => (AudioChannelSide::Right, 0.5f64),
            Position::Lfe2 => (AudioChannelSide::NotLocalized, 0.75f64),
            ...
            Position::TopCenter => (AudioChannelSide::Left, 0.66f64),
            Position::TopRearLeft => (AudioChannelSide::Left, 0.4f64),
            Position::TopRearRight => (AudioChannelSide::Right, 0.4f64),
            Position::TopSideLeft => (AudioChannelSide::Left, 0.60f64),
            Position::TopSideRight => (AudioChannelSide::Right, 0.60f64),
            Position::TopRearCenter => (AudioChannelSide::Center, 0.4f64),
            Position::BottomFrontCenter => (AudioChannelSide::Center, 0.75f64),
            Position::BottomFrontLeft => (AudioChannelSide::Left, 0.75f64),
            Position::BottomFrontRight => (AudioChannelSide::Right, 0.75f64),
            Position::WideLeft => (AudioChannelSide::Left, 0.75f64),
            Position::WideRight => (AudioChannelSide::Right, 0.75f64),
            Position::SurroundLeft => (AudioChannelSide::Left, 0.4f64),
            Position::SurroundRight => (AudioChannelSide::Right, 0.4f64),
